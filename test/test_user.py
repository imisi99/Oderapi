...
def test_user_pass_recovery(test_user):
    ...
    response = client.put("/user/password/recovery", params= {"username" : "Imisioluwa23", "email" : "isongrichard234@gmail.com",
...
def test_update_user_details(test_user):
    ...
    assert response.status_code == status.HTTP_202_ACCEPTED
    assert response.json() == "Details has been updated succesfully"
